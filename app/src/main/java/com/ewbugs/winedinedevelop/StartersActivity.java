...
public class StartersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //taken from constructor in 'Dish.java'


        Dish [] dishes = {
                new Dish("Mushroom and tofu maki", "Ask your waiter", 32),
                new Dish("Egg and avocado uramaki", "Ask your waiter", 32),
        ...
        //A variable of type ArrayAdapter which is in turn of type String
